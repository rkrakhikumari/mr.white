...
export default function SubscriptionPage(){
  ...
  <div className="bg-[#1A1A1A] p-6 rounded-md shadow relative flex">
    ...
    {/* CALL TO ACTION */}
    <button className="bg-[#D3B86A] hover:bg-[#c2a85a] text-black text-lg font-semibold px-16 py-3 rounded-lg transition duration-200 inline-flex items-center gap-2 cursor-pointer" data-aos="zoom-in"  onClick={() => navigate("/login")}>
      <TbLogin/>
      Sign up & Login
    </button>
  </div>
    ...
    <div className="max-w-365 mx-auto py-12 px-6 grid grid-cols-1 md:grid-cols-2 gap-10 items-start pb-24 ">
          ...
          <div className="bg-gradient-to-r from-[#1C1C1C] to-[#222222] rounded p-8  flex flex-col justify-between shadow-md">
            <div>
              ...
              <button className=" bg-[#D3B86A] text-black font-semibold px-6 py-3 rounded-md text-lg w-full hover:brightness-110 transition flex items-center justify-center gap-2 cursor-pointer" data-aos="zoom-in"  onClick={() => navigate("/subscriptions")}
              >
          ...
          <div className="bg-gradient-to-r from-[#1C1C1C] to-[#222222] rounded border border-[#D3B86A] p-6 flex flex-col justify-between shadow-lg relative">
            <div>
              ...
              <button className="mt-8 bg-[#D3B86A] text-black font-semibold px-6 py-3 rounded-md text-lg w-full hover:brightness-110 transition flex items-center justify-center gap-2 cursor-pointer" data-aos="zoom-in"  onClick={() => navigate("/subscriptions")}
              >
                          <PiBoneFill className="text-xl" />
              Fetch Subscription
              </button>
