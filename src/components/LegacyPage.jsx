...
import forestBg from "../assets/forest-dog-banner.png"; // banner with dog + forest
import laptopImg from "../assets/laptop-ui.png"; // black UI inside MacBook
...
export default function LegacyPage() {
  return (
    <>
      ...
      <div>
        <img src={hotel} alt="" className="w-full p-12" />
      </div>
...
<section className="bg-black text-white px-6 md:px-12 py-16">
  <div className="flex flex-col lg:flex-row items-start gap-10">
    ...
    <div className="lg:w-2/3">
      ...
      {/* Section 1 */}
      <div className="mb-6">
        <h3 className="font-bold text-lg mb-1">Full Control to Customize Your Hubs</h3>
        <p className="text-white text-md leading-relaxed">
With the Legacy of Love Living Hub, you’re in the driver’s seat. You decide what to include, update, and highlight. Add stories that capture your dog’s personality, upload favorite photos that warm your heart, and mark important milestones—like their first steps, favorite tricks, or memorable vet visits. Every detail is yours to shape, making the hub uniquely yours and your dog’s. 
      ...
      {/* Section 2 */}
      <div className="mb-6">
        <h3 className="font-bold text-lg mb-1">Mr. White Adapts and Personalizes Your Journey</h3>
        <p className="text-white text-md leading-relaxed">
      ...
      {/* Section 3 - List */}
      <div>
        <h3 className="font-bold text-lg mb-2">Creative Ways to Use Your Living Hub</h3>
        ...
        <ul className="text-white text-md list-disc list-inside space-y-2">
          <li><strong>Travel Logs:</strong> Document your adventures together—parks visited, hikes taken, and dog-friendly destinations discovered. </li>
          <li><strong>Playdate Memories:</strong>Keep track of your dog’s friends, their favorite games, and funny moments shared. </li>
          <li><strong>Health & Behavior Journals:</strong> Record patterns in mood, appetite, or activity to help spot trends and discuss with your vet. </li>
          <li><strong>Training Progress:</strong> Celebrate milestones from puppy basics to advanced commands, including notes on what worked best.</li>
          <li><strong>Special Occasions:</strong> Capture birthdays, adoption anniversaries, holidays, and everyday celebrations with photos and stories. </li>
          <li><strong>Daily Moments:</strong> Jot down those small but precious moments—like the way they tilt their head or snuggle at your feet</li>
          <li><strong>Seasonal Reflections:</strong>Note how your dog changes with the seasons, their favorite weather, and seasonal care tips. </li>
          <li><strong>Legacy Planning:</strong> Prepare thoughtful messages, wishes, or memories to share with loved ones in the future.</li>
        </ul>
...
<div class="bg-black text-white px-12 pb-10 max-w-8xl">
  <h2 class="text-3xl font-semibold flex items-center mb-6">
