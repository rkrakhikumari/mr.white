...
<Reveal axis="y" axisValue={30}>
  <button className="flex items-center gap-2 bg-[#D3B86A] px-6 py-3 rounded-md text-black font-semibold cursor-pointer" data-aos="zoom-in">
    <PiBoneFill /> View Subscriptions
  </button>
</Reveal>
