      ...
      <div className="max-w-screen-2xl w-full px-6 md:px-10 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm" data-aos="fade-up-right">
            ...
            <li><a href="#" className="hover:text-[#D3B86A]">About</a></li>
            <li><a href="#" className="hover:text-[#D3B86A]">Subscriptions</a></li>
          </ul>
        </div>
        ...
        <div>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-3">
            ...
            <button className="flex items-center gap-2 bg-[#D3B86A] text-black font-medium px-4 py-2 rounded-md text-sm sm:text-md cursor-pointer" data-aos="zoom-in">
