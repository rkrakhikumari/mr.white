  ...
  <div className="flex flex-col justify-between">
    <div className="px-12" >
      ...
      <div className="bg-[#1A1A1A] rounded-lg p-6 mb-10 mr-20">
        ...
        <button className="bg-[#D3B86A] text-xl text-black font-semibold px-5 py-2.5 rounded-md hover:brightness-110 transition flex items-center gap-2 cursor-pointer" data-aos="zoom-in">
